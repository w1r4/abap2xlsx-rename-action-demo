...
* Now let's check for visible
  ...
  METHOD clean_fieldcatalog.
    ...
    FIELD-SYMBOLS: <fs_sfcat>   TYPE yecb_s_converter_fcat.
...
*11  VARP
  ...
  METHOD loop_normal.
    ...
    FIELD-SYMBOLS: <fs_stab>   TYPE any,
                   ...
                   <fs_sfcat>  TYPE yecb_s_converter_fcat,
                   <fs_fldval> TYPE any.
...
*  lo_row_dim->set_collapsed( ip_collapsed =  <fs_sfcat>-is_collapsed ) . Not on grand total
    ...
    l_col_alpha_start = ycl_ecb_common=>convert_column2alpha( i_col_int ).
...
* Now let's check for visible
  ...
  METHOD set_autofilter_area.
    DATA: ls_area   TYPE yecb_s_autofilter_area,
          l_lines   TYPE i,
...
* Let's check for filter.
  ...
  METHOD set_fieldcatalog.
    ...
    DATA: lr_data        TYPE REF TO data,
          ...
          ls_dfies       TYPE dfies.
    DATA: ls_fcat             TYPE yecb_s_converter_fcat.
