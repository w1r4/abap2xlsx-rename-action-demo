...
TYPES:   BEGIN OF ts_subtotal_rows,
            row_int        TYPE yecb_cell_row,
            row_int_start  TYPE yecb_cell_row,
...
TYPES:   BEGIN OF ts_color_styles,
            guid_old  TYPE yecb_cell_style,
            fontcolor TYPE yecb_style_color_argb,
            fillcolor TYPE yecb_style_color_argb,
            style_new TYPE REF TO ycl_ecb_style,
