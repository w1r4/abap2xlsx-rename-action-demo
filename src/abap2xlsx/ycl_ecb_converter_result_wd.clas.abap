CLASS ycl_ecb_converter_result_wd DEFINITION
  PUBLIC
  INHERITING FROM ycl_ecb_converter_result
  FINAL
  CREATE PUBLIC .
...
CLASS ycl_ecb_converter_result_wd IMPLEMENTATION.
  ...
  METHOD create_wt_fcat.
    ...
    lt_dfies = ycl_ecb_common=>describe_structure( io_struct = lo_structdescr ).
