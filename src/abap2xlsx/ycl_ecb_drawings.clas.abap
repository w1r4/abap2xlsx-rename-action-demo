CLASS ycl_ecb_drawings DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
    DATA type TYPE yecb_drawing_type READ-ONLY VALUE 'IMAGE'. "#EC NOTEXT .  .  .  .  .  .  .  .  .  . " .
...
*"* do not include other source files here!!!
    DATA drawings TYPE REF TO ycl_ecb_collection .
ENDCLASS.



CLASS ycl_ecb_drawings IMPLEMENTATION.
