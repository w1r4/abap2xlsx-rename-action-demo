CLASS ycl_ecb_graph DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
    ...
    METHODS create_serie
      IMPORTING
        ...
        !ip_lbl_from_col     TYPE yecb_cell_column_alpha OPTIONAL
        !ip_lbl_from_row     TYPE yecb_cell_row OPTIONAL
        !ip_lbl_to_col       TYPE yecb_cell_column_alpha OPTIONAL
        !ip_lbl_to_row       TYPE yecb_cell_row OPTIONAL
        !ip_lbl              TYPE string OPTIONAL
        !ip_ref_from_col     TYPE yecb_cell_column_alpha OPTIONAL
        !ip_ref_from_row     TYPE yecb_cell_row OPTIONAL
        !ip_ref_to_col       TYPE yecb_cell_column_alpha OPTIONAL
        !ip_ref_to_row       TYPE yecb_cell_row OPTIONAL
        !ip_ref              TYPE string OPTIONAL
        !ip_sername          TYPE string
        !ip_sheet            TYPE yecb_sheet_title OPTIONAL .
    METHODS set_style
      IMPORTING
...
CLASS ycl_ecb_graph IMPLEMENTATION.
  ...
  METHOD create_serie.
    ...
    IF ip_lbl IS NOT SUPPLIED.
      ...
      ls_serie-lbl = ycl_ecb_common=>escape_string( ip_value = ls_serie-lbl ).
    ...
    IF ip_ref IS NOT SUPPLIED.
      ...
      ls_serie-ref = ycl_ecb_common=>escape_string( ip_value = ls_serie-ref ).
