...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    METHODS add
      IMPORTING
        !io_row TYPE REF TO ycl_ecb_row .
    METHODS clear .
    METHODS constructor .
    METHODS get
      IMPORTING
...
CLASS ycl_ecb_rows IMPLEMENTATION.
