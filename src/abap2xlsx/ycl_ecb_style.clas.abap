CLASS ycl_ecb_style DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    DATA font TYPE REF TO ycl_ecb_style_font .
    DATA fill TYPE REF TO ycl_ecb_style_fill .
    DATA borders TYPE REF TO ycl_ecb_style_borders .
    DATA alignment TYPE REF TO ycl_ecb_style_alignment .
    DATA number_format TYPE REF TO ycl_ecb_style_number_format .
    DATA protection TYPE REF TO ycl_ecb_style_protection .
...
CLASS ycl_ecb_style IMPLEMENTATION.
