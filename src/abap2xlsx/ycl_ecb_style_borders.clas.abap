CLASS ycl_ecb_style_borders DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    DATA allborders TYPE REF TO ycl_ecb_style_border .
    CONSTANTS c_diagonal_both TYPE yecb_diagonal VALUE 3. "#EC NOTEXT
    CONSTANTS c_diagonal_down TYPE yecb_diagonal VALUE 2. "#EC NOTEXT
    CONSTANTS c_diagonal_none TYPE yecb_diagonal VALUE 0. "#EC NOTEXT
    CONSTANTS c_diagonal_up TYPE yecb_diagonal VALUE 1.   "#EC NOTEXT
    DATA diagonal TYPE REF TO ycl_ecb_style_border .
    DATA diagonal_mode TYPE yecb_diagonal .
    DATA down TYPE REF TO ycl_ecb_style_border .
    ...
    METHODS get_structure
      RETURNING
        VALUE(es_fill) TYPE yecb_s_style_border .
...
CLASS ycl_ecb_style_borders IMPLEMENTATION.


  METHOD get_structure.
*initialize colors to 'not set'
    es_fill-left_color-indexed = ycl_ecb_style_color=>c_indexed_not_set.
    es_fill-left_color-theme = ycl_ecb_style_color=>c_theme_not_set.
    es_fill-right_color-indexed = ycl_ecb_style_color=>c_indexed_not_set.
    es_fill-right_color-theme = ycl_ecb_style_color=>c_theme_not_set.
    es_fill-top_color-indexed = ycl_ecb_style_color=>c_indexed_not_set.
    es_fill-top_color-theme = ycl_ecb_style_color=>c_theme_not_set.
    es_fill-bottom_color-indexed = ycl_ecb_style_color=>c_indexed_not_set.
    es_fill-bottom_color-theme = ycl_ecb_style_color=>c_theme_not_set.
    es_fill-diagonal_color-indexed = ycl_ecb_style_color=>c_indexed_not_set.
    es_fill-diagonal_color-theme = ycl_ecb_style_color=>c_theme_not_set.
