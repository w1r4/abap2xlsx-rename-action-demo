CLASS ltcl_test DEFINITION FOR TESTING DURATION SHORT RISK LEVEL HARMLESS FINAL.
  ...
  PRIVATE SECTION.
    DATA mi_cut       TYPE REF TO yif_ecb_style_changer.
    DATA mo_excel     TYPE REF TO ycl_ecb.
    DATA mo_worksheet TYPE REF TO ycl_ecb_worksheet.
...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD setup.
    ...
    mi_cut = ycl_ecb_style_changer=>create( mo_excel ).
  ENDMETHOD.

  METHOD apply.

    DATA lv_guid TYPE yecb_cell_style.
