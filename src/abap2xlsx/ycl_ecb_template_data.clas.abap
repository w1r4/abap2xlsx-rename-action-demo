CLASS ycl_ecb_template_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: tt_sheet_titles TYPE STANDARD TABLE OF yecb_sheet_title WITH DEFAULT KEY,
...
CLASS ycl_ecb_template_data IMPLEMENTATION.
