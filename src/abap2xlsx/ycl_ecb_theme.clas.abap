CLASS ycl_ecb_theme DEFINITION
  PUBLIC
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS set_color
      IMPORTING
        ...
        VALUE(iv_srgb)         TYPE ycl_ecb_theme_color_scheme=>t_srgb OPTIONAL
        VALUE(iv_syscolorname) TYPE string OPTIONAL
        VALUE(iv_syscolorlast) TYPE ycl_ecb_theme_color_scheme=>t_srgb OPTIONAL .
  ...
  PROTECTED SECTION.
    ...
    DATA elements TYPE REF TO ycl_ecb_theme_elements .
    DATA objectdefaults TYPE REF TO ycl_ecb_theme_objectdefaults .
    DATA extclrschemelst TYPE REF TO ycl_ecb_theme_eclrschemelst .
    DATA extlst TYPE REF TO ycl_ecb_theme_extlst .
  PRIVATE SECTION.
...
CLASS ycl_ecb_theme IMPLEMENTATION.
