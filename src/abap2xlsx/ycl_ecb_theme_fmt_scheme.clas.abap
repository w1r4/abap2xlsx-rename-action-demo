CLASS ycl_ecb_theme_fmt_scheme DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ycl_ecb_theme_fmt_scheme IMPLEMENTATION.
  ...
  METHOD load.
    fmt_scheme = ycl_ecb_common=>clone_ixml_with_namespaces( io_fmt_scheme ).
  ENDMETHOD.                    "load
