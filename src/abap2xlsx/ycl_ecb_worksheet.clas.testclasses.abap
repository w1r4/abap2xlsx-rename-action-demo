...
CLASS ycl_ecb_worksheet DEFINITION LOCAL FRIENDS
...
* ================
    DATA:
      f_cut TYPE REF TO ycl_ecb_worksheet.  "class under test
...
CLASS ltc_calculate_table_bottom_rig DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    DATA:
      ...
      field_catalog      TYPE yecb_t_fieldcatalog,
      field_catalog_line TYPE yecb_s_fieldcatalog,
      table_settings     TYPE yecb_s_table_settings.  "class under test
...
CLASS ltc_check_cell_column_formula DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    METHODS: should_fail
      IMPORTING
        ip_formula_id TYPE yecb_s_cell_data-column_formula_id
        ip_formula    TYPE yecb_s_cell_data-cell_formula OPTIONAL
        ip_value      TYPE yecb_s_cell_data-cell_value OPTIONAL
        ip_row        TYPE yecb_s_cell_data-cell_row
        ip_column     TYPE yecb_s_cell_data-cell_column
        ip_exp        TYPE string
      RAISING
        ycx_ecb.

    DATA: mt_column_formulas TYPE ycl_ecb_worksheet=>mty_th_column_formula,
          c_messages         LIKE ycl_ecb_worksheet=>c_messages.
...
CLASS ltc_check_overlapping DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    TYPES : BEGIN OF ty_parameters,
              BEGIN OF input,
                table_settings       TYPE yecb_s_table_settings,
                other_table_settings TYPE ycl_ecb_worksheet=>ty_table_settings,
              END OF input,
              BEGIN OF output,
                fails TYPE abap_bool,
              END OF output,
            END OF ty_parameters.
    DATA: table_1_settings TYPE yecb_s_table_settings.
...
CLASS ltc_normalize_column_heading DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    DATA:
      cut           TYPE REF TO ycl_ecb_worksheet,  "class under test
    ...
    METHODS:
      ...
      assert
        IMPORTING
          ...
          ip_colname_exp TYPE yecb_column_name OPTIONAL,

      assert_multi
        IMPORTING
          it_fc          TYPE yecb_t_fieldcatalog OPTIONAL
  ...
  PRIVATE SECTION.
    TYPES : BEGIN OF ty_parameters,
              BEGIN OF input,
                ...
                row          TYPE yecb_cell_row,
                row_to       TYPE yecb_cell_row,
              END OF input,
              BEGIN OF output,
                fails        TYPE abap_bool,
                column_start TYPE yecb_cell_column,
                column_end   TYPE yecb_cell_column,
...
* =============
    ...
    DATA lo_excel TYPE REF TO ycl_ecb.
...
CLASS ltc_calculate_table_bottom_rig IMPLEMENTATION.
  ...
  METHOD simple.
    ...
    ycl_ecb_worksheet=>calculate_table_bottom_right(
      EXPORTING
        ip_table         = test_table
...
CLASS ltc_check_cell_column_formula IMPLEMENTATION.
  ...
  METHOD setup.
    ...
    DATA: ls_column_formula  TYPE ycl_ecb_worksheet=>mty_s_column_formula.

    c_messages = ycl_ecb_worksheet=>c_messages.
  ...
  METHOD success.
    ...
    ycl_ecb_worksheet=>check_cell_column_formula(
  ...
  METHOD should_fail.
    ...
    DATA: lo_exception TYPE REF TO ycx_ecb.
    ...
    TRY.
      ...
      CATCH ycx_ecb INTO lo_exception.
...
CLASS ltc_check_overlapping IMPLEMENTATION.
  ...
  METHOD assert.
    DATA: error TYPE REF TO ycx_ecb.
    FIELD-SYMBOLS:
          <table> TYPE STANDARD TABLE.

    TRY.

        ycl_ecb_worksheet=>check_table_overlapping(
...
CLASS ltc_normalize_column_heading IMPLEMENTATION.
  ...
  METHOD default_text_if_none.
    ...
    CONSTANTS: lc_initial_line TYPE yecb_s_fieldcatalog VALUE IS INITIAL.
    DATA lt_fc TYPE yecb_t_fieldcatalog.
  ...
  METHOD assert.
    ...
    DATA:
      ls_fc TYPE yecb_s_fieldcatalog,
      lt_fc TYPE yecb_t_fieldcatalog.
